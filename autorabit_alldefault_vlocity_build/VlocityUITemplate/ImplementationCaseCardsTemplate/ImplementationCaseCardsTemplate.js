	...
	try {
		...
		else
		{
			...
			*/
				...
				if(actionname == 'CreateAPR' && ImplementationType!='Project' && ImplementationStatus !='RFP Review Finalized' && ((profileValue == 'Local Implementations' || profileValue == 'National Implementations' || profileValue == 'National Implementations Dual' || profileValue == 'Local Implementations Dual' || profileValue=='System Administrator'||((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') && AnthemEntity== 'Labor and Trust' && ImplementationStatus == 'Ready for Imps'))))
				{
				  console.log("Create Alphanumeric Prefix Request");
				  returnValue = true;
				}
				if(actionname == 'COB' && (ImplementationStatus == 'Initiated' || ImplementationStatus == 'Pending Response from AE') && (ImplementationType == 'New Business' || (ImplementationType == 'Renewal' && Cobquestion =='Yes') || (ImplementationType == 'Change Request Off Cycle' && Cobquestion =='Yes')) && (profileValue == 'National Sales' || profileValue == 'National Sales Dual' || profileValue=='System Administrator' || ((profileValue=='Specialty' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual') && (AnthemEntity== 'Local/Large Group' || AnthemEntity== 'Labor and Trust'))) && (ClaimSystem =='WGS 2.0' || ClaimSystem =='NASCO') )
				{
					returnValue = true;
				}
				if(actionname == 'Eligibility'&& (ImplementationStatus == 'Initiated' || ImplementationStatus == 'Pending Response from AE' || ImplementationStatus == 'Ready for Imps' )&& (ImplementationType == 'New Business' || (ImplementationType == 'Renewal' && Eligibilityquestion =='Yes') || (ImplementationType == 'Change Request Off Cycle' && Eligibilityquestion =='Yes'))
				&& (profileValue == 'National Sales' || profileValue == 'National Sales Dual' || (profileValue=='Local Implementations' && ImplementationStatus == 'Ready for Imps') ||(profileValue=='Local Implementations Dual'&& ImplementationStatus == 'Ready for Imps') ||
				((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') &&ImplementationStatus == 'Ready for Imps' && AnthemEntity== 'Labor and Trust')||
				((profileValue=='Specialty Post Sales' || profileValue=='System Administrator' || profileValue=='Specialty' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual' )  && (AnthemEntity== 'Local/Large Group' || AnthemEntity== 'Labor and Trust')))
				...
				if
				(actionname == 'Funding' 
				&& (ImplementationStatus == 'Initiated' || ImplementationStatus == 'Pending Response from AE' ||ImplementationStatus == 'Ready for Imps')
				&& (ImplementationType == 'New Business' || (ImplementationType == 'Renewal' && Fundingquestion =='Yes') || (ImplementationType == 'Change Request Off Cycle' && Fundingquestion =='Yes'))&& (profileValue == 'National Sales' || profileValue == 'National Sales Dual' || (profileValue=='Local Implementations' && ImplementationStatus == 'Ready for Imps') ||(profileValue=='Local Implementations Dual' && ImplementationStatus == 'Ready for Imps') || 
				((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') &&ImplementationStatus == 'Ready for Imps' && AnthemEntity== 'Labor and Trust')||
				((profileValue=='System Administrator' || profileValue=='Specialty' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual')  && (AnthemEntity== 'Local/Large Group' || AnthemEntity== 'Labor and Trust')))
				&& (ClaimSystem =='WGS 2.0') )
				{
				returnValue = true;
				}	
				if(actionname == 'Behavioral Health' && (((ImplementationStatus == 'Initiated'|| ImplementationStatus == 'Pending Response from AE') && (ImplementationType == 'Renewal' || ImplementationType == 'Change Request Off Cycle') && (profileValue == 'National Sales' || profileValue == 'National Sales Dual' || profileValue=='System Administrator' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual' || (profileValue=='Specialty' && (AnthemEntity== 'Local/Large Group' || AnthemEntity== 'Labor and Trust'))) && ClaimSystem =='WGS 2.0' && AretheychangesBH =='Yes - See Behavioral Health Related List For Changes') || (ImplementationStatus == 'Initiated' && ImplementationType == 'New Business' && (profileValue == 'National Sales' || profileValue == 'National Sales Dual' || profileValue=='System Administrator' || ((profileValue=='Specialty' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual') && (AnthemEntity== 'Local/Large Group' || AnthemEntity== 'Labor and Trust'))) && ClaimSystem =='WGS 2.0')))
				{
					returnValue = true;
				}
				...
				if(actionname == 'Initiate SME Engagement' && 
					ImplementationStatus !='RFP Review Finalized'&& (profileValue == 'National Implementations' || profileValue == 'National Implementations Dual' || profileValue == 'System Administrator'))
				{
					returnValue = true;
				}
          		if(actionname == 'Upload Documents' && (recordTypeValue == 'LG Local and National Renewals ReadOnly' || recordTypeValue == 'LG Renewals' || recordTypeValue == 'LG Full Group Term' || recordTypeValue == 'LG Full Group Term ReadOnly' || recordTypeValue == 'LG Renewal Lock'  || recordTypeValue == 'LG Renwal Unlock' || recordTypeValue == 'LG Change Request Off Cycle Unlock' || recordTypeValue == 'LG Local and National Change Request Off Cycle ReadOnly' || recordTypeValue == 'LG Change Request Off Cycle' || recordTypeValue == 'LG Change Request Off Cycle Lock' || recordTypeValue == 'LG New Business' || recordTypeValue == 'LG New Business ReadOnly' ||  recordTypeValue == 'LG New Business Unlock' || recordTypeValue == 'LG New Business Lock' || recordTypeValue == 'LG Local and National Pre Work ReadOnly' || recordTypeValue == 'LG Pre Work' || recordTypeValue == 'LG Pre Work Lock'|| recordTypeValue == 'LG Pre Work Unlock' || recordTypeValue == 'LG Labor and Trust') &&  (profileValue == 'Local Sales' || profileValue == 'Local Sales Dual' || profileValue=='System Administrator' || profileValue=='Specialty' || profileValue == 'Specialty Dual' || profileValue == 'Specialty Post Sales' || profileValue=='Specialty Post Sales Dual' || profileValue=='Local Implementations' || profileValue=='Local Implementations Dual'|| profileValue=='SME'|| profileValue=='SME Dual' ||((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') && AnthemEntity== 'Labor and Trust' && ImplementationStatus == 'Ready for Imps')) && (ImplementationStatus == 'Ready for Imps' || ImplementationStatus == 'Pending SME Review' || ImplementationStatus == 'Pending Response from AE' || ImplementationStatus == 'Revision Pending Response from Sales/Account Management' || ImplementationStatus == 'Approved'|| ImplementationStatus == 'Initiated'|| ImplementationStatus == 'Revision Pending Implementations Review'))   
				{
                    returnValue = true;
                }
				if(actionname == 'Load Group' && (AutomationEligible == true  && (recordTypeValue != "LG New Business" || (recordTypeValue == 'LG New Business' && approvedByGroup == true))) && (ImplementationType == 'Change Request Off Cycle' || ImplementationType == 'New Business' || ImplementationType == 'Renewal' && ImplementationStatus == 'Pending SME Review') && (loadGroupStatus == null || loadGroupStatus!='Successfully Submitted to Customer Master') && (profileValue == 'Specialty Post Sales' || profileValue == 'API User' || profileValue == 'SFDC Program Management' || profileValue == 'Local Implementations Dual' || profileValue == 'Local Implementations' || profileValue=='System Administrator'|| profileValue=='Specialty Post Sales Dual' ||((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') && AnthemEntity== 'Labor and Trust' && ImplementationStatus == 'Ready for Imps'))) //Changed By : Panthers- PRDCRM-44233
                {
                    returnValue = true;
                }
				
				if(actionname == 'Final Rate Sheet Upload' && (ImplementationType == 'New Business') && (recordTypeValue == 'LG Local and National Renewals ReadOnly' || recordTypeValue == 'LG Renewals' || recordTypeValue == 'LG Renewal Lock'  || recordTypeValue == 'LG Renwal Unlock' || recordTypeValue == 'LG Change Request Off Cycle Unlock' || recordTypeValue == 'LG Local and National Change Request Off Cycle ReadOnly' || recordTypeValue == 'LG Change Request Off Cycle' || recordTypeValue == 'LG Change Request Off Cycle Lock' || recordTypeValue == 'LG New Business' || recordTypeValue == 'LG New Business ReadOnly' ||  recordTypeValue == 'LG New Business Unlock' || recordTypeValue == 'LG New Business Lock' || recordTypeValue == 'LG Local and National Pre Work ReadOnly' || recordTypeValue == 'LG Pre Work' || recordTypeValue == 'LG Pre Work Lock'|| recordTypeValue == 'LG Pre Work Unlock' || recordTypeValue == 'LG Labor and Trust') &&  (profileValue == 'Underwriting' || profileValue == 'Underwriting Dual' || profileValue=='System Administrator' || profileValue=='Specialty Post Sales' || profileValue=='Specialty Post Sales Dual' || profileValue=='Specialty' || profileValue=='Specialty Dual' ||((profileValue == 'Local Sales' || profileValue == 'Local Sales Dual') && AnthemEntity== 'Labor and Trust' && ImplementationStatus == 'Ready for Imps')))   
				{
                    returnValue = true;
                }
