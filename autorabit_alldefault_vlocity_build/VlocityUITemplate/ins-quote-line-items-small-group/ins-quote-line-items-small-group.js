/* jshint esversion: 6 */
vlocity.cardframework.registerModule.controller('insQLISmallGroupController', ['$scope', '$rootScope', '$timeout', '$q', '$filter', 'insQLILargeGroupService', function($scope, $rootScope, $timeout, $q, $filter, insQLILargeGroupService) {
    'use strict';
    $scope.row = {};
    ...
    $scope.expandAll = function(coverages) {
        angular.forEach(coverages, function(coverage, i) {
            ...
            if (coverage.attributeCategories.records.length > 0) {
